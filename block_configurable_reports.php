...
class block_configurable_reports extends block_list {
    ...
    public function get_content() {
	    ...
	    $reports = $DB->get_records_sql('SELECT * FROM {block_configurable_reports} where global=1 ORDER BY UPPER(name) ASC');
	    ...
	    $reports = $DB->get_records_sql('SELECT * FROM {block_configurable_reports} where courseid='.$course->id.' ORDER BY UPPER(name) ASC');
